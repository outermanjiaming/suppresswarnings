...
public class ReplyAndBonus extends Context<CorpusService> {
	...
	String qrScene;
	int n = 3;
	public ReplyAndBonus(AtomicBoolean consumer, String ownerid, String openid, String qrScene, State<Context<CorpusService>> exit, CorpusService service){
		super(service);
		this.state = scan;
		this.exit = exit;
