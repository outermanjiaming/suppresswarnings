var ItemUiHelper = 
{
	...
	getPoHd: function(itemData)
	{
		return '<div class="po-hd">'
				...
				+'</div>'
				+'<span id="invest_'+itemData.projectid+'" onclick="showinvestMask(this.id)" class="glyphicon glyphicon-usd" style="padding-left:10px">投资</span>'
				+'<span id="transmit_'+itemData.projectid+'" onclick="ajaxGetQrcode(this.id)" class="glyphicon glyphicon-share" style="padding-left:10px">分享</span>'
				+'<span id="comment_'+itemData.projectid+'" onclick="showTextInput(this.id)" class="glyphicon glyphicon-comment" style="padding-left:10px">留言</span>'
				+'<span id="like_'+itemData.projectid+'" onclick="ajaxAddLike(this.id)" class="glyphicon glyphicon-heart-empty" style="padding-left:10px">点赞</span>'
			+'</div>';	
	},
