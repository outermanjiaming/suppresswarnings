var ItemUiHelper = 
{
	...
	getPoHd: function(itemData)
	{
		return '<div class="po-hd">'
				...
				+'<span id="transmit_'+itemData.projectid+'" onclick="ajaxGetQrcode(this.id)" class="glyphicon glyphicon-share">分享</span>'
				+'<span id="comment_'+itemData.projectid+'" onclick="showTextInput(this.id)" class="glyphicon glyphicon-comment">留言</span>'
				+'<span id="like_'+itemData.projectid+'" onclick="ajaxAddLike(this.id)" class="glyphicon glyphicon-heart-empty">点赞</span>'
			+'</div>';	
	},
